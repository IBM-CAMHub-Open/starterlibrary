...
# Ubuntu 18.04, https://cloud-images.ubuntu.com/locator/
variable "aws_ami" {
  type        = map(string)
  description = "loop up ami using aws region"

  default = {
    us-west-1 = "ami-0519cce8bb5c1229c"
    us-west-2 = "ami-07e60b7f43b05d68e"
    us-east-1 = "	ami-0d73480446600f555"
    us-east-2 = "	ami-0b9ecb12083282d75"
  }
}
...
apt-get install -y php php-pear libapache2-mod-php php-mysql >> $LOGFILE 2>&1 || { echo "---Failed to install php packages---" | tee -a $LOGFILE; exit 1; }
