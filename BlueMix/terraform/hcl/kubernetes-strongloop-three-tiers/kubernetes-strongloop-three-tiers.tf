...
module "install_kubernetes_strongloop_three_tiers" {
  ...
  module_script_variables = "${var.count} ${var.mongodb_user_password} https://raw.githubusercontent.com/IBM-CAMHub-Open/terraform-modules/master/ibmcloud/virtual_guest/files/installStrongloopThreeTiers"
